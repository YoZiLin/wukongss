...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        private void UpdateTrayIcon()
        {
            ...
            string text = I18N.GetString("悟空加速") + "\n" +
                          (enabled ?
        ...
        private void LoadMenu()
        {
            ...
            this.ConfigItem.Visible = false;
            this.contextMenu1.MenuItems[3].Visible = false;
            this.proxyItem.Visible = false;
            this.ShareOverLANItem.Visible = false;
            this.contextMenu1.MenuItems[4].Visible = false;
            this.contextMenu1.MenuItems[5].Visible = false;
            this.contextMenu1.MenuItems[9].Visible = false;
            this.VerboseLoggingToggleItem.Visible = false;
            this.hotKeyItem.Visible = false;
            this.contextMenu1.MenuItems[12].Visible = false;
        }
        ...
        {
            Process.Start("https://www.wukongss.com/");
        }
